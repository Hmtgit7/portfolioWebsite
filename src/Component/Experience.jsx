...
const Experience = () => {
  const Images = [
    ...
    { id: 3, src: graphql, title: "GraphQL", style: "shadow-pink-500" },
    ...
    { id: 8, src: nextjs, title: "Next.js", style: "shadow-red-500" },
    { id: 9, src: tailwind, title: "Tailwind", style: "shadow-cyan-500" },
  ];
